...
prefix="cmk"
location="eastus"
resource_group="$prefix-key-vault"
...
az keyvault create -n $key_vault_name -g $resource_group -l $location --sku Premium
...
az role assignment create --role "Storage Account Key Operator Service Role" --assignee 'https://vault.azure.net' --scope $sa_id
